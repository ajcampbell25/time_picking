...
def headers_frame(self,root):
    ...
    #                print('{:<32}: {}'.format(keys,value))
        ...
        save_button = tk.Button(self.printframe, text="Save Table", command=lambda: headers_gui.save_text(self,file_hed))
